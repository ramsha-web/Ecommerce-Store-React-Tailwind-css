  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 text-center text-white p-8">
        ...
        <button className="px-6 py-3 bg-orange-600 hover:bg-orange-700 text-white text-lg rounded-lg transition transform hover:scale-110 duration-300 ease-in-out">
          Shop Now
        </button>
      </div>
    </section>
